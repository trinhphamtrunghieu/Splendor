...
(function (global) {
  ...
  var STRINGS = {
    vi: {
      ...
      'turn.yours': 'Lượt của bạn',
      'turn.yoursNamed': 'Lượt của {p}',
      'turn.waiting': 'Đang chờ {p}…',
      'turn.thinking': '{p} đang suy nghĩ…',
      ...
      'turn.hint.locked': 'Chưa chọn được đá quý.',
      ...
      'menu.online': 'Chơi qua mạng',
      'menu.online.desc': '2–4 người ở xa nhau, mỗi người một máy. Không cần server.',

      'net.yourName': 'Tên của bạn',
      'net.broker': 'Máy chủ tin nhắn (MQTT)',
      'net.broker.hint': 'Dùng broker MQTT công cộng qua WebSocket — không cần cài gì. Bạn có thể thay bằng broker riêng (phải là wss://).',
      'net.createRoom': 'Tạo phòng mới',
      'net.joinRoom': 'Vào phòng',
      'net.resumeRoom': 'Vào lại phòng gần nhất',
      'net.lobby': 'Phòng chờ',
      'net.copy': 'Copy mã',
      'net.copied': 'Đã copy mã {code}',
      'net.badCode': 'Mã phòng gồm 5 chữ/số.',
      'net.host': 'chủ phòng',
      'net.addBot': 'Thêm máy',
      'net.start': 'Bắt đầu ván',
      'net.closeRoom': 'Đóng phòng',
      'net.leaveRoom': 'Rời phòng',
      'net.connecting': 'Đang kết nối…',
      'net.hostWaiting': 'Đã kết nối. Chia mã phòng cho bạn bè rồi bấm Bắt đầu.',
      'net.guestWaiting': 'Đã vào phòng. Đang chờ chủ phòng bắt đầu…',
      'net.lobbyHint': 'Mọi người mở cùng đường link, chọn “Chơi qua mạng” rồi nhập mã phòng. Máy của chủ phòng làm trọng tài nên chủ phòng cần giữ tab mở.',
      'net.needTwo': 'Cần ít nhất 2 người chơi.',
      'net.notYourTurn': 'Chưa tới lượt bạn.',
      'net.waitingFor': 'Đang chờ {p}…',
      'net.sending': 'Đang gửi nước đi…',
      'net.offline': 'mất kết nối',
      'net.playerLeft': '{p} đã mất kết nối.',
      'net.hostClosed': 'Chủ phòng đã đóng phòng.',
      'net.roomFull': 'Phòng đã đủ 4 người.',
      'net.roomInProgress': 'Phòng đang chơi giữa ván, không vào được.',
      'net.error': 'Lỗi: {e}',
      'net.searchingRoom': 'Đã kết nối. Đang tìm phòng {code}…',
      'net.reconnecting': 'Mất kết nối — đang thử lại (lần {n})…',
      'net.changeBroker': 'Đổi broker',
      'net.copyLink': 'Copy link mời',
      'net.copiedLink': 'Đã copy link mời — gửi cho bạn bè là họ vào được ngay.',
      'net.invited': 'Bạn được mời vào phòng {code}. Nhập tên rồi bấm Vào phòng.',
      'net.hostGoneShort': 'chủ phòng mất kết nối',
      'net.err.hostGone': 'Chủ phòng mất kết nối. Ván đang tạm dừng — nếu họ quay lại, ván tiếp tục ngay.',
      'net.err.brokerUnreachable': 'Không kết nối được tới {url}. Mạng của bạn có thể đang chặn broker này — thử đổi sang broker khác.',
      'net.err.roomNotFound': 'Không tìm thấy phòng {code}. Kiểm tra lại mã, và cả hai người phải dùng cùng một broker.',

      'net.rename': 'Đổi tên',
      'net.renameTitle': 'Đổi tên của bạn',
      'net.renameBody': 'Đổi thoải mái tới khi chủ phòng bấm Bắt đầu. Sau đó tên được ghi vào ván nên không đổi được nữa.',
      'net.renameSave': 'Lưu tên',
      'net.renameEmpty': 'Tên không được để trống.',
      'net.renameLocked': 'Ván đã bắt đầu nên không đổi tên được nữa.',
      'net.renameSame': 'Vẫn là tên cũ.',
      'net.renameDone': 'Giờ bạn là {p}.',
      'net.renameOffline': 'Đang mất kết nối nên chưa đổi tên được. Thử lại khi có mạng.',
      'net.nameLimit': 'Tối đa {n} ký tự.',

      'chat.title': 'Nhắn trong phòng',
      'chat.open': 'Mở khung chat',
      'chat.placeholder': 'Nhắn gì đó…',
      'chat.send': 'Gửi',
      'chat.empty': 'Chưa ai nói gì. Bạn mở lời đi.',
      'chat.offline': 'Mất kết nối nên chưa gửi được.',
      'chat.tooFast': 'Từ từ thôi — gửi nhanh quá.',
      'chat.joined': '{p} đã vào phòng.',
      'chat.left': '{p} mất kết nối.',
      'chat.renamed': '{a} giờ là {b}.',
      'chat.started': 'Ván bắt đầu.',
      'chat.unread': '{n} tin mới',
    ...
    en: {
      ...
      'turn.yoursNamed': '{p}\u2019s turn',
      'turn.waiting': 'Waiting for {p}…',
      'turn.thinking': '{p} is thinking…',
      ...
      'turn.hint.locked': 'Gems are locked until then.',
      ...
      'menu.online.desc': '2–4 players on their own devices, anywhere. No server needed.',

      'net.yourName': 'Your name',
      'net.broker': 'Message broker (MQTT)',
      'net.broker.hint': 'Uses a public MQTT broker over WebSocket — nothing to install. You can point this at your own broker instead (it must be wss://).',
      'net.createRoom': 'Create a room',
      'net.joinRoom': 'Join room',
      'net.resumeRoom': 'Back to your last room',
      'net.lobby': 'Lobby',
      'net.copy': 'Copy code',
      'net.copied': 'Copied {code}',
      'net.badCode': 'A room code is 5 letters or digits.',
      'net.host': 'host',
      'net.addBot': 'Add a bot',
      'net.start': 'Start the game',
      'net.closeRoom': 'Close room',
      'net.leaveRoom': 'Leave room',
      'net.connecting': 'Connecting…',
      'net.hostWaiting': 'Connected. Share the room code, then press Start.',
      'net.guestWaiting': 'In the room. Waiting for the host to start…',
      'net.lobbyHint': 'Everyone opens the same link, picks “Play online” and types the room code. The host\u2019s browser is the referee, so the host needs to keep their tab open.',
      'net.needTwo': 'At least two players are needed.',
      'net.notYourTurn': 'It is not your turn.',
      'net.waitingFor': 'Waiting for {p}…',
      'net.sending': 'Sending your move…',
      'net.offline': 'disconnected',
      'net.playerLeft': '{p} lost their connection.',
      'net.hostClosed': 'The host closed the room.',
      'net.roomFull': 'That room already has four players.',
      'net.roomInProgress': 'That room is mid-game and cannot be joined.',
      'net.error': 'Error: {e}',
      'net.searchingRoom': 'Connected. Looking for room {code}…',
      'net.reconnecting': 'Connection lost — retrying (attempt {n})…',
      'net.changeBroker': 'Change broker',
      'net.copyLink': 'Copy invite link',
      'net.copiedLink': 'Invite link copied — anyone who opens it lands in this room.',
      'net.invited': 'You were invited to room {code}. Enter your name, then press Join.',
      'net.hostGoneShort': 'host disconnected',
      'net.err.hostGone': 'The host lost their connection. The game is paused — it resumes the moment they are back.',
      'net.err.brokerUnreachable': 'Could not reach {url}. Your network may be blocking this broker — try a different one.',
      'net.err.roomNotFound': 'No room {code} found. Check the code, and make sure both of you are on the same broker.',

      'net.rename': 'Change name',
      'net.renameTitle': 'Change your name',
      'net.renameBody': 'Change it as often as you like until the host starts the game. After that the name is written into the game and fixed.',
      'net.renameSave': 'Save name',
      'net.renameEmpty': 'A name cannot be empty.',
      'net.renameLocked': 'The game has started, so names are fixed now.',
      'net.renameSame': 'That is already your name.',
      'net.renameDone': 'You are {p} now.',
      'net.renameOffline': 'Offline, so the name did not change. Try again once you are back.',
      'net.nameLimit': 'Up to {n} characters.',

      'chat.title': 'Room chat',
      'chat.open': 'Open chat',
      'chat.placeholder': 'Say something…',
      'chat.send': 'Send',
      'chat.empty': 'Nobody has said anything yet. Go first.',
      'chat.offline': 'Offline, so that did not go out.',
      'chat.tooFast': 'Easy — that was too fast.',
      'chat.joined': '{p} joined.',
      'chat.left': '{p} lost connection.',
      'chat.renamed': '{a} is now {b}.',
      'chat.started': 'The game has started.',
      'chat.unread': '{n} new',
